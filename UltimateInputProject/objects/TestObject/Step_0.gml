...
currentInputConfig = Input.CheckPressed("SwitchMode", "Default") ? !currentInputConfig : currentInputConfig;
Input.SetConfiguration(inputConfigurations[currentInputConfig]);
